...
export default {
  ...
  methods: {
    ...
    getItems() {
      let url=`https://vue-daily-report-2ab66.firebaseio.com/items.json?orderBy="$key"&startAt="${this.$route.params.date}"&endAt="${this.$route.params.date}-22-24"`;
    ...
    updateItem(item) {
      let url = `https://vue-daily-report-2ab66.firebaseio.com/items/${item.id}.json`;
